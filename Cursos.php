...
<head>
  ...
  <title>Cursos De Profundizacion</title>
...
<body>
    ...
    <div class="parallax-quote parallaxBg" style="padding: 0px 30px; height: 120px;">
      <div class="parallax-quote-in" style="padding: 0px;">
        <div class="row">
          ...
          <div class="col-4 ">
            <h1 style="padding:35px 0px 0px 0px; color: white; font-size: 42px;">CURSOS OFERTADOS</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  <nav class="navbar navbar-expand-lg sticky-top navbar-dark bg-danger">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">UFPS</a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      <a class="navbar-brand" href="./Paginas/AcercaDe.php">ACERCA-DE</a>
      <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent"
        aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
    ...
    <table class="table table-borderless">
      ...
      <tbody>
        <tr>
          ...
          <td>INACTIVO</td>
          <td><a href="Paginas/studentRegister.php"><i class="fi fi-sr-edit" style="color: red;" ></i></a></td>
        </tr>
        <tr>

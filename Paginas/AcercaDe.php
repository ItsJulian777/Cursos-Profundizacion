...
<div class="container">
  <div class="row">
      ...
      <div class="row">
          <div class="col-7">
              <p class="">
                ...
                para estudiantes que buscan puestos de trabajo de primer nivel en la industria de las TICs o 
                como prerrequisito para mejorar las competencias para prepararse en carreras especializadas en TICs. 
                CCNA Routing y Switching ofrece una cobertura integral y completa de temas de redes de computadores, 
                desde los fundamentos a las aplicaciones y servicios avanzados, de igual manera proporciona 
                oportunidades para adquirir experiencia mediante la práctica y el desarrollo de habilidades para el 
                diseño y la implementación de redes en <b>PYMES.</b>
                <br><br>
                El plan de estudios es apropiado para estudiantes de diferentes niveles educativos y tipos de 
                instituciones, como Universidades, colegios profesionales y escuelas técnicas.
              </p>
          </div>
          <div class="col-5">
              <img class="responsive-img" src="public/imagenes/dfa.png" alt="" style="max-height:260px;">
              <hr>
              <p>
                La Universidad Francisco de Paula Santander a través del grupo de investigación <b>GIRET</b> 
                (Grupo de Investigación en Redes de Computadores y Telecomunicaciones) elaboró un convenio 
                con Cisco System <b>Network Academy</b> para ofrecer en la región el programa de Certificación 
    ...
    <div class="col-6">
      ...
      <hr>
      <div class="">
        <img src="../Image/cisco1.jpg" alt="Foto" class="imagenCisco">
      </div>
    </div>
</div>
</div>
